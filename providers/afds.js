 ...
 * Generated: 2026-04-10T07:18:31.701Z
 */
    ...
    try {
      ...
      for (const file of searchData.files) {
        ...
        if (!cleanTitle.includes(cleanBaseName)) {
          console.log(`[AFDS] Skipped (Title Mismatch): ${name}`);
          continue;
        }
...
${quality} | ${size}`,
      ...
      console.log(`[AFDS] Successfully found ${streams.length} streams!`);
      return streams;
    } catch (e) {
