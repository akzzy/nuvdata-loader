 ...
 * Generated: 2026-04-10T12:12:04.664Z
 */
...
${quality} | ${formatBytes(parseInt(file.file_size))}`,
          // The Worker handles the heavy lifting, no rate limits!
          url: `${WORKER_URL}/stream.mkv?id=${file.id}`,
          quality,
          // Forcing Nuvio to keep the afds headers during the Cloudflare redirect
          behaviorHints: {
            notWebReady: true,
            proxyHeaders: {
              request: {
                "User-Agent": USER_AGENT,
                "Referer": "https://afds.pages.dev/",
                "Origin": "https://afds.pages.dev/"
              }
            }
          }
        });
