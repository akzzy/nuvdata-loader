 ...
 * Generated: 2026-04-09T20:19:45.335Z
 */
  ...
  return __async(this, null, function* () {
    try {
      ...
      for (const file of searchData.files) {
        ...
        if (/\.zip$/i.test(name) || /part[0-9]/i.test(name))
          continue;
        let quality = "SD";
      ...
      const streamPromises = candidates.map((file) => __async(this, null, function* () {
...
${file.quality} | ${file.size}`,
            ...
            headers: {
              ...
              // Using indexer as referer for the dl link
