 ...
 * Generated: 2026-04-10T12:01:31.338Z
 */
...
${quality} | ${formatBytes(parseInt(file.file_size))}`,
          // We add /stream.mkv so Nuvio knows it's a video right away
          url: `${WORKER_URL}/stream.mkv?id=${file.id}`,
          quality,
          // This is the magic command that forces Nuvio to proxy the headers
          behaviorHints: {
            notWebReady: true,
            proxyHeaders: {
              request: {
